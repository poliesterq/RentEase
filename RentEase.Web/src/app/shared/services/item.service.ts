    ...
    getAll():Observable<Item[]>{    
      ...
      this.route.queryParams.subscribe(queryParams => {
        if(!!queryParams['searchParameter']) {
          httpParams = httpParams.append("SearchParameter", queryParams['searchParameter']);
        }
      });
      this.route.queryParams.subscribe(queryParams => {
        if(!!queryParams['categories']){
          httpParams = httpParams.append("Categories", queryParams['categories']);
        }
      });
      this.route.queryParams.subscribe(queryParams => {
      ...
      this.route.queryParams.subscribe(queryParams => {
        if(!!queryParams['isAvailable']){
          httpParams = httpParams.append("IsAvailable", queryParams['isAvailable']);
        }
      });
